...
if av>bv and av>cv:
    print ('A l\'emporte dans ' + str(av/(av+bv+cv)*100) + ' % des cas.')
if bv>av and bv>cv:
    print ('B l\'emporte dans ' + str(bv/(av+bv+cv)*100) + ' % des cas.')
if cv>av and cv>bv:
    print ('C l\'emporte dans ' + str(cv/(av+bv+cv)*100) + ' % des cas.')
